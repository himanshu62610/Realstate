...
function url(public_id) {
  ...
  if (type === null && public_id.match(/^https?:\
    return original_source;
  }
  ...
  if (sign_url && isEmpty(auth_token)) {
    ...
    var truncated = compute_hash(to_sign + api_secret, signatureConfig.algorithm, 'base64').slice(0, signatureConfig.signatureLength).replace(/\
