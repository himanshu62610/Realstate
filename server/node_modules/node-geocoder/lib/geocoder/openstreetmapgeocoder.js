...
var OpenStreetMapGeocoder = function OpenStreetMapGeocoder(httpAdapter, options) {
    ...
    var osmServer = (options && options.osmServer) || 'http:
...
OpenStreetMapGeocoder.prototype._endpoint = 'https:

OpenStreetMapGeocoder.prototype._endpoint_reverse = 'https:

/**
* Geocode
* @param <string|object>   value    Value to geocode (Address or parameters, as specified at https:
...
/**
* Reverse geocoding
* @param {lat:<number>,lon:<number>, ...}  lat: Latitude, lon: Longitude, ... see https:
* @param <function> callback Callback method
*/
